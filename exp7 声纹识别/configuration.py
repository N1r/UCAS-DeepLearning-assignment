...
data_arg.add_argument('--sr', type=int, default=44100, help="sampling rate")
...
data_arg.add_argument('--tisv_frame', type=int, default=80, help="max frame number of utterances of tdsv")
...
model_arg.add_argument('--model_num', type=int, default=2, help="number of ckpt file to load")

# Training Parameters
train_arg = parser.add_argument_group('Training')
train_arg.add_argument('--train', type=str2bool, default=False, help="train session or not(test session)")
train_arg.add_argument('--N', type=int, default=16, help="number of speakers of batch")
